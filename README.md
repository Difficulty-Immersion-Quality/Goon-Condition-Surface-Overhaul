# Goon's Condition and Surface Overhaul

[https://bg3.norbyte.dev/search?q=valuelist+"Surface+Type"](https://bg3.norbyte.dev/search?q=valuelist+"Surface+Type")

## Surfaces:
| Surface Type                         | #  | Display name      | Interactions   | Status applied | Effects        |
|--------------------------------------|----|-------------------|----------------|----------------|----------------|
| "Acid"                               | 16 | Acid              |                | "ACID"         | AC debuff      |
| "Alcohol"                            | 22 | Alcohol           | Ignite, freeze |                |                |
| "Alienoil"                           | 20 | Mysterious Liquid | Ignite         |                |                |
| "Ash"                                | 29 |                   |                |                |                |
| "Blackpowder"                        | 18 |                   |                |                |                |
